		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section class="home-slider" id="up">
				<!-- swiper-wrapper start -->
			  	<div class="swiper-wrapper">
						      	...
						      	<div class="six-columns six-offset">
							      	<div class="content-left-margin-40">
								      	<h2 class="large-title-bold">
							  				<span class="slider-title-fill slider-tr-delay01" data-text="Nos geramos">Nos geramos</span><br>
							  				<span class="slider-title-fill slider-tr-delay02" data-text="criatividade &">criatividade &</span><br>
							  				<span class="slider-title-fill slider-tr-delay03" data-text="ideia inovadoras">ideia inovadoras</span>
						  				</h2>
						  				<p class="p-style-bold-up text-height-20 d-flex-wrap">
										  	<span class="slider-title-fill slider-tr-delay04" data-text="#storche #marketing">#storche #marketing</span>
										  	<span class="slider-title-fill slider-tr-delay05" data-text="#tamojunto #inovação">#tamojunto #inovação</span>
										  	<span class="slider-title-fill slider-tr-delay06" data-text="#suamarca #inovadores">#suamarca #inovadores</span>
									  	</p>
									  	<div class="slider-fade slider-tr-delay07 top-margin-30">
										  	<div class="border-btn-box border-btn-red pointer-large">
												<div class="innerborder-btn-">
										      		<a href="#" class="border-btn" data-text="Leia mais">Leia mais</a>
										    	</div>
											</div>
									  	</div>
							      	</div>
				    ...
				    <div class="swiper-slide flex-min-height-box home-slide">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image:url(assets/images/backgrounds/agencia2.jpg)"></div>
				      	<!-- home-slider-content start -->
					  	<div class="home-slider-content flex-min-height-inner dark-bg-2">
					      	...
					      	<div class="container top-bottom-padding-120 flex-container response-999">
						      	...
						      	<div class="six-columns six-offset">
							      	<div class="content-left-margin-40">
								      	<h2 class="slider-overlay2 medium-title red-color">Sejam bem vindos</h2>
								      	<h3 class="large-title-bold text-color-4">
							  				<span class="slider-overlay2 slider-tr-delay01">Melhores soluções</span><br>
							  				<span class="slider-overlay2 slider-tr-delay02">& ideias para</span><br>
							  				<span class="slider-overlay2 slider-tr-delay03">Seu negócio</span>
						  				</h3>
				    ...
				    <div class="swiper-slide flex-min-height-box home-slide red-slide">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image:url(assets/images/backgrounds/agencia3.jpg)"></div>
				      	<!-- home-slider-content start -->
					  	<div class="home-slider-content flex-min-height-inner red-bg">
					      	...
					      	<div class="container top-bottom-padding-120 flex-container response-999">
						      	...
						      	<div class="six-columns">
							      	<h2 class="large-title-bold">
						  				<span class="slider-title-fill slider-tr-delay01" data-text="Provendo">Provendo</span><br>
						  				<span class="slider-title-fill slider-tr-delay02" data-text="O melhor">O melhor </span><br>
						  				<span class="slider-title-fill slider-tr-delay03" data-text="Serviço digital">Serviço digital</span>
					  				</h2>
								  	...
								  	<div class="arrow-btn-box slider-fade slider-tr-delay06 top-margin-30">
										<a href="#" class="arrow-btn pointer-large">Leia mais</a>
									</div>
						      	</div><!-- column end -->
					      	</div><!-- flex-container end -->
				      	</div><!-- home-slider-content end -->
						...
						<div data-animation-container class="flex-container">
							...
							<div class="twelve-columns text-center">
								<h2 class="large-title text-height-12">
									<span data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="Somos criativos">Somos criativos</span><br>
									<span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="Somos storche">Somos storche</span>
								</h2>
							</div><!-- column end -->
							<!-- column start -->
							<div class="six-columns">
			...
			<section class="light-bg-1 bottom-padding-30 top-padding-120" data-midnight="black">
				...
				<div data-animation-container class="container small bottom-padding-60 text-center">
					<h2 data-animation-child class="large-title text-height-10 text-color-1 overlay-anim-box2" data-animation="overlay-anim2">Recentes trabalhos</h2><br>
					<p data-animation-child class="fade-anim-box tr-delay02 text-color-1 xsmall-title-oswald top-margin-5" data-animation="fade-anim">Nós oferecemos soluções</p>
				</div><!-- container end -->
							...
							<div class="flex-container container small">
								...
								<div data-animation-container class="six-columns">
									<div class="content-right-margin-40">
										<span class="small-title-oswald red-color overlay-anim-box2" data-animation="overlay-anim2">Identidade visual</span>
										<h3 class="title-style text-color-1">
											<span data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">Nome do cliente</span><br>
										...
										<div data-animation-child class="arrow-btn-box top-margin-30 fade-anim-box tr-delay05" data-animation="fade-anim">
											<a href="#" class="arrow-btn pointer-large animsition-link">Leia mais</a>
										</div>
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/cliente.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/projeto.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
									<div class="content-left-margin-40">
										...
										<div data-animation-child class="arrow-btn-box top-margin-30 fade-anim-box tr-delay05" data-animation="fade-anim">
											<a href="project.html" class="arrow-btn pointer-large animsition-link">Leia mais</a>
										</div>
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/projeto2.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
						</div><!-- portfolio-content-inner end -->
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/projeto3.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
			...
			<!-- section start Princais clientes-->
			<section class="dark-bg-2">
				<!-- container start -->
				<div class="container small top-bottom-padding-120">
					<!-- medium-title start -->
					<h2 data-animation-container class="medium-title">
						<span data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="Nossos">Nossos</span><br>
						<span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="Principais">Principais</span><br>
						<span data-animation-child class="title-fill tr-delay02" data-animation="title-fill-anim" data-text="Clientes">Clientes</span>
					</h2><!-- medium-title end -->
				...
				<div class="testimonials-slider container small">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/adult-beanie-black-background-1529350.jpeg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4-1 p-style-bold">Copper mug vexillologist +1 prism iPhone fashion axe portland. Hella quinoa woke blog af umami tacos freegan vinyl snackwave microdosing. Fanny pack direct trade XOXO drinking vinegar. Live-edge kinfolk master cleanse brooklyn meh organic man braid. Actually humblebrag sriracha authentic chia. IPhone glossier schlitz fam, la croix keytar retro offal. Artisan selfies mlkshk pinterest gastropub knausgaard live-edge.</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								Nome cliente, <span class="text-color-2">empresa</span>
							</div>
						</div><!-- slide end -->
						<!-- slide start -->
						<div class="swiper-slide text-center">
			...
			<div class="video-content-bg" style="background-image:url(assets/images/backgrounds/business-calligraphy-chinese-lanterns-1455969.jpeg)">
